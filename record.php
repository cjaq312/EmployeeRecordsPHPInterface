	...
	<body id="backgroundbody">
			...
			<div id="left_panel">
				<div id="left_panel_row">
					...
					<br/>
					<br/>
					<a href="Search.html">PreRecords</a>
					<br/>
					<br/>
					<br/>
					<br/>
...
elseif($loser == 0)
{
echo"<table border='2'><tr><th>USER</th><th>SSN</th><th>FIRST NAME</th><th>LAST NAME</th><th>AGE</th><th>ADDRESS</th><th>VALID START-TIME</th><th>VALID END-TIME</th></tr>";
while($r1=mysql_fetch_array($search))
{
echo"<tr><td>".$r1["user"]."</td><td>".$r1["ssn"]."</td><td>".$r1["fname"]."</td><td>".$r1["lname"]."</td><td>".$r1["age"]."</td><td>".$r1["address"]."</td><td>".$r1["vnt"]."</td><td>".$r1["vet"]."</td></tr>";
}
echo"</table>";
}
}
